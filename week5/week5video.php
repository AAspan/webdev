<?php
define( 'DB_NAME', 'cspaniolramos1‘ );
define( ‘DB_USER’, ‘cspaniolramos1‘ );
define( ‘DB_PASSWORD’, ‘cspaniolramos1‘ );
...
// Create connection
	...
	if (mysqli_num_rows($result) > 0) {
	  ...
	  while($row = mysqli_fetch_assoc($result)) {
	  	$delurl = “[<a href='https://codd.cs.gsu.edu/~cspaniolramos/week5video.php?cmd=delete&id={$row['id']}'>delete</a>]”;
